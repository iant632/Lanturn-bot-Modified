	...
	async def checkDataReady(self):
		...
		if self.userChannel1 != None and not checkDuduStatus1():
			...
			if pk != 0:
				...
				if year > 100 or month > 12 or day > 31 or pk > 890:

					await self.userChannel1.send(self.id1 + ", sorry but I couldn't read your file. Try a different pokemon!")
					self.clearData1()
					removePK81()
		...
		if self.userChannel2 != None and not checkDuduStatus2():
			...
			if pk != 0:
				...
				if year > 100 or month > 12 or day > 31 or pk > 890:
					...
					await self.userChannel2.send(self.id2 + ", sorry but I couldn't read your file. Try a different pokemon!")
					self.clearData2()
					removePK82()
